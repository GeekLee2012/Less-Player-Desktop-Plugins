...
export const activate = async () => {
  ...
  console.log('[ PLUGIN - Activated ] 电波平台 - 央广云听')
}

//插件停用
export const deactivate = () => {
  //归还权限
  access(APIPermissions.REMOVE_PLATFORM, RadioCN.CODE)
  access(APIPermissions.REMOVE_REQUEST_HANDLER, RadioCN.CODE)
  console.log('[ PLUGIN - Deactivated ] 电波平台 - 央广云听')
}