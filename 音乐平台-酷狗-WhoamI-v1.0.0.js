...
const signParam = (param) => {
    if(typeof param == 'object') param = qsStringify(param)
            ...
            getDoc(url).then(doc => {
                ...
                if (scriptText) {
                    ...
                    list.forEach(item => {
                        ...
                        const track = new Track(item.audio_id, KuGou.CODE, songname, artist, album, duration, trackCover)
...
export const deactivate = () => {
  //归还权限
  access(APIPermissions.REMOVE_PLATFORM, KuGou.CODE)
  access(APIPermissions.REMOVE_REQUEST_HANDLER, KuGou.CODE)
