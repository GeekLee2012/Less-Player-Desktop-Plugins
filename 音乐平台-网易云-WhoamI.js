...
const { isBlank, toTrimString, toMillis, toYmd, getImageUrlByQuality, } = utils
const { md5, randomText, rsaEncrypt, aesDecryptText, aesEncryptDefault, aesEncryptHexText, } = crypto
const { getDoc, postJson, } = nets
...
class NetEase {
    ...
    static artistDetail(id) {
        return new Promise((resolve, reject) => {
            ...
            getDoc(url, null, getDefaultConfig()).then(doc => {
